...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 12, 2023 at 03:01 PM
...
(3, 'Replentes', 'Josep', 'P.', 'n/a', 'Blk 18 Lot 79 Site 3', '2018-10-28', 4, 'Male', 'none', '', 7, 8, 1, '', '', ''),
...
(33, 'Montenegro', 'Agustin', 'Allerite', '', 'Blk 29 Lot 32 Site 3', '1957-02-14', 66, 'Male', '921218221', '', NULL, 1, 22, 'Diarrhea,Constipation', 'Allergy,PTB', 'None');
...
(1, 3, 1, 62, 0, 202, 55, 141, 0, 0.12530530445967827),
(2, 3, 1, 77, 0, 201, 36, 140, 0, 0.2458018883010377),
(3, 3, 0, 62, 0, 262, 6, 102, 0, 0),
(4, 3, 1, 62, 0, 202, 55, 141, 0, 0.00177913812),
(5, 3, 1, 62, 0, 202, 55, 141, 0, 0.0017465811299999998),
(6, 3, 1, 62, 0, 202, 55, 141, 0, 0.12530530445967827),
(7, 3, 1, 62, 0, 218, 74, 133, 1, 0.10313992919771856),
(8, 3, 0, 78, 1, 176, 31, 83, 1, 0);
...
--
ALTER TABLE `prediction_record`
  MODIFY `prediction_number` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
